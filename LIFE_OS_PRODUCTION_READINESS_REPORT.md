...
> Исторический отчёт об июньской версии. Для текущего дерева см. [аудит 8 сентября](audits/system-audit-2026-09-08/REPORT.md) и [исправления с повторной проверкой](audits/system-audit-2026-09-08/REMEDIATION.md). Этот документ не подтверждает готовность последующих изменений.
